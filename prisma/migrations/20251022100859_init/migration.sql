...
-- AddForeignKey
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_related_comment_id_fkey" FOREIGN KEY ("related_comment_id") REFERENCES "comments"("id") ON DELETE SET NULL ON UPDATE CASCADE;
